 ...
 */
export const MODERN_THEME_DILEMMA_IDS = ["ai-autonomy", "privacy-vs-security"] as const;
...
import bgAiAutonomy from "@/shared/assets/dilemmas/ai-autonomy/background.png?format=webp";
